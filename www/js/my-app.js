...
myApp.onPageInit("seguimiento",function(){
  ...
  let myPhotoBrowserPopupDark = myApp.photoBrowser({
    photos : [
        {
            html: '<iframe src="https://firebasestorage.googleapis.com/v0/b/ruttic-20670.appspot.com/o/videos%2Fvideo2.mp4?alt=media&token=ede44a7d-ba4c-4293-94e5-771053f5af22" frameborder="0" allowfullscreen></iframe>',
            caption: 'EJEMPLO'
        }
    ],
    theme: 'dark',
...
// --------------------------------------------------------------------------------------
//cuando inicia ejercicio
// --------------------------------------------------------------------------------------

myApp.onPageInit("ejercicios",function(){


  // var almacenamiento= firebase.storage();
  // var miref=almacenamiento.ref();
  // var imagen_ref=miref.child("imagenes/imagen1");
  
  
  // console.log(imagen_ref.getDownloadURL());
